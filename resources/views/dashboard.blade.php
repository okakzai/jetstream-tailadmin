  ...
  >
    ...
    >
      ...
      <a href="index.html" class="lg:hidden">
        <img class="dark:hidden" src="{{ asset('logo.png') }}" alt="Logo" />
        <img
            ...
            <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ env('APP_URL') }}/template/tailadmin/src/images/user/user-02.jpg"
                      alt="User"
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ env('APP_URL') }}/template/tailadmin/src/images/user/user-03.jpg"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ env('APP_URL') }}/template/tailadmin/src/images/user/user-04.jpg"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ env('APP_URL') }}/template/tailadmin/src/images/user/user-05.jpg"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
            <img src="{{ env('APP_URL') }}/template/tailadmin/src/images/user/owner.jpg" alt="User" />
          </span>
...
>
  ...
  <div class="space-y-5">
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-3">
        <div class="w-full max-w-8 items-center rounded-full">
          <img src="{{ env('APP_URL') }}/template/tailadmin/src/images/country/country-01.svg" alt="usa" />
        </div>
        <div>
          <p
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-3">
        <div class="w-full max-w-8 items-center rounded-full">
          <img src="{{ env('APP_URL') }}/template/tailadmin/src/images/country/country-02.svg" alt="france" />
        </div>
        <div>
          <p
            class="text-theme-sm font-semibold text-gray-800 dark:text-white/90"
            ...
            <div class="flex items-center">
              <div class="flex items-center gap-3">
                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                  <img src="{{ env('APP_URL') }}/template/tailadmin/src/images/product/product-01.jpg" alt="Product" />
                </div>
                <div>
                  <p
        ...
        <tr>
          <td class="py-3">
            <div class="flex items-center">
              <div class="flex items-center gap-3">
                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                  <img src="{{ env('APP_URL') }}/template/tailadmin/src/images/product/product-02.jpg" alt="Product" />
                </div>
                <div>
                  <p
                    class="font-medium text-gray-800 text-theme-sm dark:text-white/90"
        ...
        <tr>
          <td class="py-3">
            <div class="flex items-center">
              <div class="flex items-center gap-3">
                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                  <img src="{{ env('APP_URL') }}/template/tailadmin/src/images/product/product-03.jpg" alt="Product" />
                </div>
                <div>
                  <p
                    class="font-medium text-gray-800 text-theme-sm dark:text-white/90"
        ...
        <tr>
          <td class="py-3">
            <div class="flex items-center">
              <div class="flex items-center gap-3">
                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                  <img src="{{ env('APP_URL') }}/template/tailadmin/src/images/product/product-04.jpg" alt="Product" />
                </div>
                <div>
                  <p
                    class="font-medium text-gray-800 text-theme-sm dark:text-white/90"
        ...
        <tr>
          <td class="py-3">
            <div class="flex items-center">
              <div class="flex items-center gap-3">
                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                  <img src="{{ env('APP_URL') }}/template/tailadmin/src/images/product/product-05.jpg" alt="Product" />
                </div>
                <div>
                  <p
                    class="font-medium text-gray-800 text-theme-sm dark:text-white/90"
