...
<head>
    ...
    <title>@yield('title', 'Error') - {{ config('app.name', 'Admin') }}</title>
...
<body
    x-data="@yield('data', "{ page: 'page404', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }")"
    x-init="
